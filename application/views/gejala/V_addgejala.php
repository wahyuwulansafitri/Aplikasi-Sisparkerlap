            ...
            <div class="col-md-12">
                <form class="form-group" method="post" action="">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="gejala" id="gejala" placeholder="Masukkan Gejala" value="<?= set_value('gejala'); ?>">
                        <?= form_error('gejala', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Bobot</label><br>
                        <small class="text-danger">Masukkan Nilai dari 1/3/5 !</small>
                    ...
                    <div class="form-group">
                        <span class="text-danger">* Semakin besar nilai bobot, semakin besar pengaruh gejala terhadap kerusakan.</span>
                    </div>
                </form>
            </div>
        </div>
