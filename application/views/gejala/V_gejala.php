                    ...
                    <tbody>
                        ...
                        foreach ($ciri as $row) { ?>
                            <tr>
                                ...
                                <td><?= $row['bobot']; ?></td>
                                <td>
                                    <a title="Hapus Data" href="<?= base_url('gejala/hapus/' . $row['id_ciri']) ?>" class="btn btn-circle btn-outline-danger" onclick="return confirm('Anda yakin menghapus data ini ?');"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php }; ?>
                    </tbody>
