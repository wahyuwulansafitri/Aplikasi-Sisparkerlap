...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
            <h6 class="m-0 font-weight-bold text-primary">Data Kerusakan <?= $kerusakan['nama_jenis']; ?></h6>
        </a>
        <!-- Card Content - Collapse -->
        <div class="collapse show" id="collapseCardExample">
            <div class="card-body">
                <h5 class="card-title"><strong><?= $kerusakan['nama_jenis']; ?></strong></h5>
                <p class="card-text text-justify"><?= $kerusakan['detail_jenis']; ?></p>
            </div>
        </div>
    </div>

    <div class="d-sm-flex align-items-right justify-content-end mb-4 mr-4">
        <a href="<?= base_url('klasifikasi/tambahGejala/') . $id_jenis; ?>" class="d-none d-sm-inline-block btn btn-sm btn-outline-primary shadow-sm"><i class="fas fa-plus fa-sm"></i> Tambah Gejala</a>
    </div>
