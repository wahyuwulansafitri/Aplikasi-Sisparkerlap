   ...
   <div class="card shadow mb-4">
      ...
      <div class="card-body">
         <form class="form-group" method="post" action="">
            ...
            <div class="row">
               <div class="col-md-12">
                  <label for="exampleFormControlSelect1">Nama Kerusakan</label>
                  <div class="input-group mb-3">
                     <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect01">Kerusakan</label>
                     </div>
                     <select class="custom-select" id="kerusakan" name="kerusakan">
                        <option value="" selected>Pilih Kerusakan...</option>
                        <?php foreach ($kerusakan as $row) { ?>
                           <option value="<?= $row['id_jenis']; ?>"><?= $row['nama_jenis']; ?></option>
                        <?php }; ?>
                     </select>
                  </div>
                  <?= form_error('kerusakan', '<small class="text-danger">', '</small><br><br>'); ?>
               </div>
