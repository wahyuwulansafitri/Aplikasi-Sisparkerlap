...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="collapse show" id="collapseCardExample">
            <div class="card-body">
                <h5 class="card-title text-center" style="font-weight:lighter"><strong><?= $kerusakan['nama_jenis']; ?></strong></h5><br>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><?= $sub_judul . " " . $kerusakan['nama_jenis']; ?></h6>
        </div>
        <div class="card-body">
            <h5 class="card-title text-center" style="font-weight:lighter"><strong>Silahkan Masukkan Gejala</strong></h5>
            <form class="form-group" method="post" action="">
                <input type="hidden" name="id_jenis" id="id_jenis" value="<?= $kerusakan['id_jenis']; ?>">
