                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input readonly type="text" class="form-control col-md-lg" name="id_jenis" id="id_jenis" value="<?= $kerusakan['id_jenis']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control col-md-lg" name="kerusakan" id="kerusakan" value="<?= $kerusakan['nama_jenis']; ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea type="text" rows="4" class="form-control col-md-lg" name="detail" id="detail"><?= $kerusakan['detail_jenis']; ?></textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea type="text" rows="4" class="form-control col-md-lg" name="solusi" id="solusi"><?= $kerusakan['solusi_jenis']; ?></textarea>
